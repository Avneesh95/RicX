      ...
      {open && (
        ...
        >
          <motion.div
            ...
            animate={{ scale: 1, y: 0 }}
            exit={{ scale: 0.9, y: 30 }}
            className="w-full max-w-lg rounded-3xl bg-white shadow-2xl p-8"
          >
            ...
            <div className="space-y-4">
              {permissionList.map((item) => (
                <label
                  key={item.key}
                  className="flex justify-between items-center border rounded-xl p-4 cursor-pointer hover:bg-gray-50"
                >
