      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6 relative">
            <h2 className="text-2xl font-bold mb-4 text-gray-800">Create New Coupon</h2>
        ...
        <table className="w-full bg-white">
          ...
          <tbody>
            {coupons.length === 0 ? (
              ...
              coupons.map((coupon) => (
                <tr key={coupon._id} className="border-b text-center hover:bg-gray-50">
                  <td className="p-4 font-bold tracking-wider text-gray-800">
                    {coupon.code}
                  </td>
                  <td>
                  ...
                  <td>
                    {coupon.showOnHero ? (
                      <span className="text-yellow-600 font-bold text-sm bg-yellow-50 px-2.5 py-1 rounded-full border border-yellow-200">
                        ⭐ Hero Banner
                      </span>
                    ) : (
